...
function addTask(taskValue, isCompleted = false) {
    ...
    text.style.textDecoration = isCompleted ?
    'line-through' : 'none';
...
function saveTasks() {
    ...
    (function (taskLi) {
        const text = taskLi.querySelector('span').
        textContent;
        const isCompleted = taskLi.querySelector('input').
        checked;
...
function toggleTask(event) {
    ...
    text.style.textDecoration = event.target.checked ?
    'line-through' : 'none';
    saveTasks();
}
